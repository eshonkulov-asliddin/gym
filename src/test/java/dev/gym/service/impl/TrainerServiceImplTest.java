...
class TrainerServiceImplTest {
    ...
    void givenValidRegisterTrainerDto_whenRegister_thenReturnUserDto() {
        ...
        when(userDto.username()).thenReturn("trainerUsername");
        when(userDto.password()).thenReturn("trainerPassword");
        ...
        assert registeredUserDto != null;
        assertEquals("trainerUsername", registeredUserDto.username());
        assertEquals("trainerPassword", registeredUserDto.password());
    }
    ...
    void givenValidTrainerUsernameAndUpdateTrainerDtoRequest_whenUpdate_thenReturnTrainerDto() {
        ...
        assert registeredTrainerDto != null;
